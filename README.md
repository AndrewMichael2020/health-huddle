...
At eight fifty-nine, the Agents’ Project board for Skagit Health’s LTC Data Modernization work waited beneath the pale light of six columns: Backlog, Ready, In Progress, Blocked, Review, and Done. Downstairs, the human analysts were drinking coffee and talking beside the windows, well aware that thirteen small decisions had already lined up in an action ledger above them.
